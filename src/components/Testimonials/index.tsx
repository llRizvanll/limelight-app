...
const Testimonials: React.FC<Testimonial> = ({ name }) => {
  ...
  return (
    <div className={`${styles.root} 'mx-2 2xl:mx-32'`}>
      ...
      <div
        className={`${styles.carouselContainer} '!pt-[88px] !mt-[88px] border-t border-[#66656333] w-full'`}
      >
        ...
        <div className="flex flex-col ml-[25%] mr-[25%] md:flex-row lg:flex-row justify-between mb-[24px] md:mb-[80px] lg:mb-[80px] items-center md:ml-0 md:mr-0 lg:ml-0 lg:mr-0">
          <h2 className={styles.heading}>
            People <span className="text-[#414BC1] italic"> love </span> us for
            our services.
          </h2>
          <div
            style={{
        ...
        <div className={`${styles.wrapper} 'mt-[88px]'`}>
          ...
          >
            {testimonialsData.map((item, index) => {
              ...
              const isNextCard =
                index === (activeSlideIndex + 1) % testimonialsData.length;
        ...
        {name && (
          <div className={styles.splitSofaBottom}>
            ...
            <ChatButton
              number="+971-581364466"
              color="text-custom-blue"
              hoverolor="hover:bg-light-silver"
              bgColor="bg-light-silver"
            />
          </div>
        )}
      </div>
...
export const testimonialsData = [
  {
    ...
    review: `“Qudee's nano-coating has been a game-changer for my home. My furniture now stays spotless and protected, making maintenance effortless and preserving its elegance.“`,
  },
  {
    ...
    review: `“Thanks to Qudee’s nano-coating service, my interiors look flawless and stay that way even with heavy use. It’s the best decision I’ve made to keep my space looking pristine.“`,
  },
  {
    name: "Mohamed Marfin",
    ...
    review: `“Qudee transformed my apartment with their expert fit-out services. The design blends functionality and luxury perfectly, creating a space that feels both practical and sophisticated.“`,
  },
  {
    name: "Ziad Dardary",
    ...
    review: `“The attention to detail in Qudee’s fit-out services is unmatched. Every element of my office space reflects style and sophistication, making it a pleasure to work in.“`,
  },
  {
    name: "Dalia Bahii",
    ...
    review: `“From start to finish, the Qudee team was professional and meticulous. The fit-out for my villa is not only functional but also stunningly designed—it’s become the centerpiece of my home.“`,
  },
  // {
  //   name: "Peggy Olson",
  //   location: "Bur Dubai, Dubai",
